...
namespace JobVacancy.API.Migrations
{
    ...
    [Migration("20251127232559_RemovedRequiredColumnVersionImageTableMediaBaseEntity")]
    partial class RemovedRequiredColumnVersionImageTableMediaBaseEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.Base.MediaBaseEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.UserContentReactionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");

                    b.Property<string>("CommentEnterpriseId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
                    ...
                    b.HasIndex("CommentEnterpriseId");
                    ...
                    b.ToTable("UserContentReaction", (string)null);
                });
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.PostUserMediaEntity", b =>
                {
                    b.HasBaseType("JobVacancy.API.models.entities.Base.MediaBaseEntity");
                    ...
                    b.ToTable("PostUserMedias", (string)null);
                });
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.FollowerRelationshipUserEntity", b =>
                {
                    b.HasOne("JobVacancy.API.models.entities.UserEntity", "Followed")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("JobVacancy.API.models.entities.UserEntity", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.UserContentReactionEntity", b =>
                {
                    b.HasOne("JobVacancy.API.models.entities.CommentPostEnterpriseEntity", "CommentEnterprise")
                        .WithMany("Reactions")
                        .HasForeignKey("CommentEnterpriseId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("JobVacancy.API.models.entities.CommentPostUserEntity", "CommentUser")
                        .WithMany("Reactions")
                    ...
                    b.Navigation("CommentEnterprise");
            ...
            modelBuilder.Entity("JobVacancy.API.models.entities.PostUserMediaEntity", b =>
                {
                    b.HasOne("JobVacancy.API.models.entities.Base.MediaBaseEntity", null)
                        .WithOne()
                        .HasForeignKey("JobVacancy.API.models.entities.PostUserMediaEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

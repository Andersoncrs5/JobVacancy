...
public class FavoriteCommentPostUserRepository(AppDbContext db, IRedisService redisService): GenericRepository<FavoriteCommentEntity>(db, redisService),  IFavoriteCommentPostUserRepository
{
